...
HubRegistry.prototype.init = function (gulp) {
	...
	var self = this;
	_each(this._gulpfiles, function(gulpfile) {
...
//gutil.log('here')
	...
	_each(this._registry, function(subregistry, subfileName) {
		...
		_each(subtasks, function(subtask, name) {
			...
			var newtask = subtask.unwrap();
			newtask.displayName = subname;
	...
	_each(master, function(subtasks, name) {
