...
module.exports = {
  ...
  controller: function ( dataService, $scope) {
      ...
      // Default latency 
      for (i = 0; i < this.numberOfVMs; i++) {
                if( this.LatencySensitivity[i] == "" || this.LatencySensitivity[i] == "false"|| this.LatencySensitivity[i] == "true"||
                    typeof this.LatencySensitivity[i] == undefined ){
      ...
      for (i = 0; i < this.LatencySensitivity.length; i++) {
                 if(( i < this.numberOfVMs ) && ( this.LatencySensitivity[i] == "" || this.LatencySensitivity[i] == "false"|| 
                             this.LatencySensitivity[i] == "true"||typeof this.LatencySensitivity[i] == undefined )){
      ...
      for (i = 0; i < this.MemoryReservation.length; i++) {
          if(( i < this.numberOfVMs ) && (this.MemoryReservation[i] == "" || this.MemoryReservation[i] == "false"|| 
                      this.MemoryReservation[i] == "true"||typeof this.MemoryReservation[i] == undefined )){
